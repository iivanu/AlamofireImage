...
Fork should be used for AlamofireImage 3.6.0 and Alamofire 4.9.0 with Swift Package Manager
...
- Then search for https://github.com/iivanu/AlamofireImage.git
- And choose the version 3.6.0
- After that you just import AlamofireImage.
